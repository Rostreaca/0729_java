...
public class UncheckedException {
	...
	public void method1() {
		...
		try { // 예외가 발생할 수도 있는 코드만 기술(반드시!!)
			System.out.println(num1 / num2); // 예외가 발생하는 즉시 try블럭 안의 다른 코드 무시하고 catch구문으로 점프
	...
	public void method3() {
		...
		System.out.println("100번째 인덱스 값을 출력 : "+arr[100]);
		} catch(InputMismatchException e) { //특정클래스(RuntimeException)의 후손
		    e.printStackTrace(); // 얘는 꼭 개발단계에서만
			System.out.println("정수넣어");
		} catch(RuntimeException e) {
			System.out.println("아마 음수를 입력했거나 100보다 크지 않은 값을 입력함");
		}
		
		/*catch(NegativeArraySizeException e) {
			System.out.println("음수넣지마");
		} catch(ArrayIndexOutOfBoundsException e) {
			System.out.println("101보다 큰 수 넣으셈");
		}*/
	}
