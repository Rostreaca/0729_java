		...
		*/
		...
		for(int i =0; i<arr.length;i++) {
			...
			*/
			...
			/*
			 * 동적 바인딩(Dynamic Binding) : 프로그램 "실행 전" 컴파일 시점에 정적바인딩 수행(자료형의 메소드를 가리킴)
