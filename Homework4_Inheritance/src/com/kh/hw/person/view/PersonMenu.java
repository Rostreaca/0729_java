...
public class PersonMenu {
	...
	public void mainMenu() {
		...
		while (true) {
			int[] memberCount = pc.personCount();
			System.out.println("학생은 최대 3명까지 저장할 수 있습니다.");
			System.out.println("현재 저장된 학생은 " + memberCount[0] + "명입니다.");
			System.out.println("사원은 최대 10명까지 저장할 수 있습니다.");
			System.out.println("현재 저장된 사원은 " + memberCount[1] + "명입니다.");
			System.out.println();
