...
public class Array {
	 ...
	 * 
	 * 자바라는 '언어 자체에 내장된' 유일한 자료구조 : 값을 어떻게 저장할것인가?
	 * 
	...
	public void method1() {
		...
		/*
		 * int num1 = 22; int num2 = 1; int num3 = 59; int num4 = 17; int num5 = 35;
		 * 
		 * int sum = 0; sum = num1 + num2 + num3 + num4 + num5;
		 * 
	...
	public void methodA() {
		...
		/*
		 * System.out.println(integers); System.out.println(integers[0]); integers[0] =
		 * 1;
		 * 
		 * /* 기본자료형 : boolean, char, byte, short, int, long, float, double => 변수 공간에 실제
		 * 값을 바로 담을 수 있음 : (지역) 변수
		 * 
		 * 
		 ...
		 * 
		 * for(int index=0; index<5;index++) { System.out.println(KH정보교육원종로지원[index]); }
		 */
	...
	public void methodB() {
		 ...
		 * out of bounds for length 5 at com.kh.array.Array.methodB(Array.java:250) at
	...
	public void methodC() {
		...
		for (int i = 0; i < nums.length; i++) {
			...
			nums[i] = sc.nextInt();
			System.out.println("nums라는 배열의" + i + "번째 인덱스에 대입된 값 : " + nums[i]);
		}
		System.out.println(Arrays.toString(nums));

		// 2. 해당 배열의 요소중 가장 작은 값 == 최소값을 출력하는 것이 목적
	...
	public void methodD() {
		...
		// 자바의 언어의 특성 중 하나 : 자동 메모리 관리 - 가비지 컬렉터(garbage collector)가 메모리의 heap 영역에 남아있는
		// 사용되지 않는 주소나 값을 삭제함.
