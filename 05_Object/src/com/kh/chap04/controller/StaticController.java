...
public class StaticController {
	...
	// 소멸 시점 : 프로그램 종료
	// 객체를 생성을 하지 않고 static영역에 할당!! 필드 -> heap 변수 -> stack 클래스변수 -> static
	 ...
	 * 
	 * [ 표현법 ]
	 * public static final 자료형 상수필드식별자 = 값; 상수 > 값을 변경하지 않을 변수 공간
	 * => 예약어 순서는 상관X public final static 으로 작성해도 돌아감
