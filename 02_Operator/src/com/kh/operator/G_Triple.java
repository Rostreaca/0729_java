...
public class G_Triple {
	...
	public void method1() {
		...
		System.out.println("1.딸기 아이스크림");
		System.out.println("2.아이스 아메리카노");
		System.out.println("3.망고 빙수");
		...
		String selectedMenu = (menuNo == 1)? "딸기 아이스크림을 주문하셨습니다."
				              :(menuNo ==2)? "아이스 아메리카노를 주문하셨습니다." 
				              :(menuNo ==3)? "망고 빙수를 주문하셨습니다."
				              :"없는 메뉴를 주문하셨습니다.";
		// 조건식 ? 조건식이 true일 경우 결과 값 : 조건식이 false일 경우 결과 값
		
		// 선택한 번호에 따라서 메뉴명을 출력
		// 1번 입력시 == "(1번 메뉴)를 주문하셨습니다"
	...
	public void Practice(){
		...
		// 입력받은 알파벳이 소문자인지 / 대문자인지 판별 후 출력해주세요. 65 97
		Scanner sc = new Scanner(System.in);
		boolean b = true;
			...
			String result = (alphabet >=65 && alphabet< 90) ? "대문자"
					:(alphabet >= 97 &&alphabet <= 122) ? "소문자"
					:"잘못된 값입니다";
			
			
			System.out.println(alphabet + "은(는) " + result + "입니다");
