...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 추상적 자료형(Abstract Data Type,ADT) ==> Interface + 구현체 => Class + 알고리즘 => method
		 * 
		 * 
		 * 
		 * =================================================
		 ...
		 * 크기를 넘어서는 상황이 발생하면 알아서 확장된다. 2. 중간에 값을 추가하거나 삭제하는 경우 기존값을 밀어주거나 땡겨주는 로직이 이미
		 * 구현되어 있음 => 그때그때 필요한 메소드들을 호출해서 사용하면 됨
		 * 
		 ...
		 * -> ArrayList 
		 * - Set 계열 : 다루고자 하는 값(Value)만 저장 / 저장시 순서 유지 X,중복값 허용 X 
		 * => HashSet, TreeSet 
		 * -> HashSet 
		...
		// 2. 인자로 전달한 정수값만큼의 크기르 가진 리스트를 만들겠다.
		...
		// add메소드 호출 시 오버로딩 된 형태의 메소드를 사용
