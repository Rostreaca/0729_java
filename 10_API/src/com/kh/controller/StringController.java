...
public class StringController {
	 ...
	 * String 클래스 사용방법
	 * 
	 * 1. new 연산자를 사용해서 String 클래스의 생성자를 호출하는 방법 2. 대입연산자를 이용해서 문자열 리터럴값을 대입하는 방법
	 */
	...
	public void method1() {
		...
		// 실제 담겨있는 문자열 리터럴 value값을 반환하게 오버라이딩
	...
	public void method4() {
		...
		StringBuffer sb = new StringBuffer(); // 동시제어 가능
	...
	public void stringMethod() {
		...
		for(int i = 0; i < chArr.length; i++) { //for - loop
...
//		new String(chArr).chars().mapToObj(c->(char)c).forEach(System.out::println);
		...
		// 8. 문자열.toUpperCase() : String -> 싸그리 대문자로 바꾸기
		...
		if(answer.toUpperCase().equals("Y")) {//메소드 체이닝, 콜백 함수
			System.out.println("밤양갱");
		}
	...
	public void split() {
		...
		// 배열의 요소를 수정할 순 없음 (출력, 옮겨담을 때 주로 사용)
		...
		/*
		 * System.out.println("토크나이저로 뽑아야지"); System.out.println(stn.nextToken());
