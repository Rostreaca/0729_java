...
public class A_Break {
	...
	/*
	 *  ** 주의사항 : switch문 내부에 작성하는 break문 과는 구분을 해야 할 필요가 있음!
	 *             switch 문 내부에 있는 break는 switch문을 빠져나가는 용도로 사용
	 * 
	...
	public void prc001()
	{
		...
		while(true)
		{
			...
			System.out.print("정수값을 입력해주세요(음수 입력시 종료) > ");
			int num = sc.nextInt();
