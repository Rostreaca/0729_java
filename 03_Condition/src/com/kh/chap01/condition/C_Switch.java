...
public class C_Switch {
	...
	*/
	...
	public void method1()
	{
		...
		int price = 0;
		/*
		 * switch(menu) { case "부찌" : price =11000; break; case "떡갈비" : price
		 * =13000;break; case "칼국수" : price = 8000;break; case "제육","수제비" : price
		 * =7000;break; default : System.out.println("없는 메뉴입니다"); }
		 */
		//중복제거하기
		//1.중복된 부분은 하나로 빼기
		//2. 중복이 아닌 부분은 변수로 처리
	...
	public void login()	{	
		...
		// 사용자가 로그인 시 입력한 비밀번호 값과 회원가입시 가입한 비밀번호값이 동일하다면
		...
		// => 기본자료형의 경우 동등비교연산자를 수행하는데 있어 문제가 없음(==,!=)
